...
const openrouterGetFiles = async () => {
    try {
        ...
        const resModelsList = response.data.data;

        console.log(resModelsList);
...
// npx ts-node -r dotenv/config ./srcTest/2025-09-14-openrouter-get-files/2025-09-14-groq-get-files.ts